...
float getAlpha()
{
    vec3 viewDir = normalize(view_pos - vec3(fs_in.frag_pos));
    vec2 textureCoord = get_parallax_mapping_texcoord(material, fs_in.texture_coord, viewDir);
